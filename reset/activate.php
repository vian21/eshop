...
function send($email, $id)
{
    ...
    $content = "<h2 style='font-family:Arial, Helvetica, sans-serif;'>Reset Your Account Password</h2>";

    $content .= "<p style='line-height: 1.5;font-family:Arial, Helvetica, sans-serif;'>Click on the button below to reset your account password</p><br><br>";
